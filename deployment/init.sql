...
CREATE TABLE ad_placements (
 ...
 status TINYINT DEFAULT 1,
 frequency_cap INT DEFAULT 1 COMMENT '每分钟最大展示次数',
...
CREATE TABLE dramas (
 ...
 status TINYINT DEFAULT 1 COMMENT '1:上线 2:完结',
 vip_level TINYINT DEFAULT 0 COMMENT '0:免费 1:VIP1 2:VIP2 3:VIP3',
 release_date DATE,
...
CREATE TABLE assets (
 ...
 apy DECIMAL(5,2),
 duration_days INT,
 status TINYINT DEFAULT 0 COMMENT '0:待发行 1:募资中 2:进行中 3:已结束',
...
CREATE TABLE orders (
 ...
 amount DECIMAL(20,8) NOT NULL,
 status TINYINT DEFAULT 0 COMMENT '0:挂单 1:部分成交 2:全部成交 3:已取消',
 liquidity_source TINYINT DEFAULT 1 COMMENT '1:C2C 订单簿 2:AMM 底池',
 slippage_rate DECIMAL(5,4) COMMENT '成交滑点率',
 created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE points_transactions (
 ...
 source_id VARCHAR(64) COMMENT '关联 ID',
 created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE vip_orders (
 ...
 payment_method TINYINT NOT NULL COMMENT '1:微信 2:支付宝 3:REEL',
 status TINYINT DEFAULT 0,
 pay_time TIMESTAMP,
 created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE stake_earnings_periods (
 ...
 event_trigger VARCHAR(20) COMMENT '触发事件：VIP_CHANGE / DEPOSIT / WITHDRAW',
...
CREATE TABLE withdrawals (
 ...
 risk_check_result JSON COMMENT '详细风控结果 {ip_risk, device_risk, behavior_risk}',
